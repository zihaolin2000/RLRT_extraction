...
print "\\setlist[itemize]{noitemsep, topsep=0pt}\n";
...
#    $text =~ s/<ul>/\\begin{itemize}\\leftmargin0em\\setlength\\itemsep{-0.5em}\\itemindent0pt/sig;
    $text =~ s/<ul>/\\begin{itemize}\\leftmargin0em\\itemindent0pt/sig;

...
module gamma2pi_Amplitudes
  ...
  !****************************************************************************
  !****g* gamma2pi_Amplitudes/inMedium_delta_width
  ! SOURCE
  ...
  !****************************************************************************
  !****g* gamma2pi_Amplitudes/inMedium_delta_potential
  ! SOURCE
  ...
  !****************************************************************************
  !****g* gamma2pi_Amplitudes/inMedium_nucleon_potential
  ! SOURCE
  ...
  !****************************************************************************
  !****g* gamma2pi_Amplitudes/inMedium_pion_potential
  ! SOURCE
  ...
  !****************************************************************************
  !****g* gamma2pi_Amplitudes/buuPotential
  ! SOURCE
  ...
  !****************************************************************************
  !****g* gamma2pi_Amplitudes/debugFlag
  ! SOURCE
...
contains
  ...
  subroutine init
    ...
    !**************************************************************************
    !****n* gamma2pi_Amplitudes/Amplitudes_2pi
    ! NAME
    ...
    ! * buuPotential
    !**************************************************************************
    NAMELIST /Amplitudes_2pi/ inMedium_delta_width, &
         inMedium_delta_potential, inMedium_nucleon_potential, &
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   complex function dpi(p)
     ...
     if (inMedium_pion_potential) then
        pBoosted=p
        ! Boost to LRF
        call Lorentz(betaToLRF,pBoosted)
        ! Include pion potential :
        call setToDefault(teilchen)
        teilchen%ID=pion
        teilchen%pos=position
        teilchen%mom=pBoosted/GEV_to_INVfm
        teilchen%anti=.false.
        teilchen%pert=.true.
...
end module gamma2pi_Amplitudes

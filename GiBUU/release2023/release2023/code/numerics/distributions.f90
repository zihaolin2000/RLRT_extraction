...
contains
  ...
  !****************************************************************************
  !****f* distributions/Sigmoid
  ! NAME
  ! real function Sigmoid(x, x0, dx)
  !
  ! PURPOSE
  ! Returns the value of the sigmoid function, which used for smooth turning
  ! on and off of individual subprocesses,

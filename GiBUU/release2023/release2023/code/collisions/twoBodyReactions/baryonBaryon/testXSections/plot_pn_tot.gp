...
set terminal postscript eps enhanced color dl 1 "Helvetica" 18 size 5,4
...
plot \
     ...
     f1 u 2:3             lt 1 lc 1 lw w3 t 'tot', \
     f1 u 2:6             lt 2 lc 1 dt 2 lw w t 'NN', \
     f1 u 2:7             lt 1 dt 1 lc 2 lw w t 'N{/Symbol D}', \
     f1 u 2:4             lt 1 dt 2 lc 2 lw w t 'NN*', \
     f1 u 2:5             lt 1 dt 3 lc 2 lw w t 'N{/Symbol D}*', \
     f1 u 2:39            lt 1 dt 1 lc 3 lw w t '{/Symbol DD}', \
     f1 u 2:37            lt 1 dt 2 lc 3 lw w t '{/Symbol D}N*', \
     f1 u 2:38            lt 1 dt 3 lc 3 lw w t '{/Symbol DD}*', \
     f2 u 2:($4+$5+$6+$7) lt 1 lc 4 lw w t 'NN{/Symbol p}', \
     f2 u 2:($8+$9+$10)   lt 1 lc 5 lw w t '{/Symbol w/f}', \
     f2 u 2:11            lt 8 lc 1 dt 3 lw w t 'BYK', \
...
plot \
     ...
     f1 u (Ekin($2)):3             lt 1 lc 1 lw w3 t 'tot', \
     f1 u (Ekin($2)):6             lt 2 lc 1 dt 2 lw w t 'NN', \
     f1 u (Ekin($2)):7             lt 1 dt 1 lc 2 lw w t 'N{/Symbol D}', \
     f1 u (Ekin($2)):4             lt 1 dt 2 lc 2 lw w t 'NN*', \
     f1 u (Ekin($2)):5             lt 1 dt 3 lc 2 lw w t 'N{/Symbol D}*', \
     f1 u (Ekin($2)):39            lt 1 dt 1 lc 3 lw w t '{/Symbol DD}', \
     f1 u (Ekin($2)):37            lt 1 dt 2 lc 3 lw w t '{/Symbol D}N*', \
     f1 u (Ekin($2)):38            lt 1 dt 3 lc 3 lw w t '{/Symbol DD}*', \
     f2 u (Ekin($2)):($4+$5+$6+$7) lt 1 lc 4 lw w t 'NN{/Symbol p}', \
     f2 u (Ekin($2)):($8+$9+$10)   lt 1 lc 5 lw w t '{/Symbol w/f}', \
     f2 u (Ekin($2)):11            lt 8 lc 1 dt 3 lw w t 'BYK', \
...
plot \
     ...
     f1 u (srts($2)):3              lt 1 lc 1 lw w3 t 'tot', \
     f1 u (srts($2)):6              lt 2 lc 1 dt 2 lw w t 'NN', \
     f1 u (srts($2)):7              lt 1 dt 1 lc 2 lw w t 'N{/Symbol D}', \
     f1 u (srts($2)):4              lt 1 dt 2 lc 2 lw w t 'NN*', \
     f1 u (srts($2)):5              lt 1 dt 3 lc 2 lw w t 'N{/Symbol D}*', \
     f1 u (srts($2)):39             lt 1 dt 1 lc 3 lw w t '{/Symbol DD}', \
     f1 u (srts($2)):37             lt 1 dt 2 lc 3 lw w t '{/Symbol D}N*', \
     f1 u (srts($2)):38             lt 1 dt 3 lc 3 lw w t '{/Symbol DD}*', \
     f2 u (srts($2)):($4+$5+$6+$7)  lt 1 lc 4 lw w t 'NN{/Symbol p}', \
     f2 u (srts($2)):($8+$9+$10)    lt 1 lc 5 lw w t '{/Symbol w/f}', \
     f2 u (srts($2)):11             lt 8 lc 1 dt 3 lw w t 'BYK', \
     ...
     x>3.0?sigTot(plab(x)):1/0 not lc -1 dt 2
...
plot \
     d1a u (srts($2)):5:(srts($3)):(srts($4)):($5+$6):($5-$7) w xyerrorbars lt 1 lc 0 pt 7 ps 0.6 t 'data (np, inel.)', \
     d1b u (srts($2)):5:(srts($3)):(srts($4)):($5+$6):($5-$7) w xyerrorbars lt 1 lc 0 pt 6 ps 0.6 t 'data (pn, inel.)', \
     ...
     d1a u (srts($2)):5:(srts($3)):(srts($4)):($5+$6):($5-$7) w xyerrorbars lt 1 lc 0 pt 7 ps 0.6 not, \
     d1b u (srts($2)):5:(srts($3)):(srts($4)):($5+$6):($5-$7) w xyerrorbars lt 1 lc 0 pt 6 ps 0.6 not, \
     x>3.0?sigInel(plab(x)):1/0 not lc -1 dt 2

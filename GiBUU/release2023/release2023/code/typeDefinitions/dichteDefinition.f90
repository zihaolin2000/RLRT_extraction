...
module dichteDefinition
  ...
  type, public :: dichte
     ...
     real,dimension(0:3) :: charge = 0.   ! full charge flux  in units 1/fm**3
  end type dichte
  !****************************************************************************

  type(dichte), parameter, public :: dichte0 = dichte(0)

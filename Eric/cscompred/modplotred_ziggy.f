...
c     & 0.71092E-02,0.78423E-01,0.29565E+00,0.62607E+00,-.13227E+00 /
     ...
     & 0.99939E+00,0.10522E+01,0.10366E+01,0.10000E+01,0.94905E+01 /      
      ...
      ! read(5,*) e, theta
      read(5,*) e, theta, nu !!! read E0, theta, nu from user - Ziggy
      ...
      do i=1,1 !!! print only one line, so no loop - Ziggy
        ! ep = epmax-i*de
        ep = e - nu !!! calculate ep from E0 and nu - Ziggy
        q2 = 4.*e*ep*sin2
        w2 =  mp2+2.*mp*nu-q2
        if(coulomb) then
         call vcoul(A,Z,veff)
        ...
        ! nu = e-ep !!! nu is given, so comment out this line - Ziggy
        q2v = 4.*ev*epv*sin2
...
c           if(q2.GT.0.3) nuccs = 0.0
        ...
        enddo
        nuccstot = nuccstot/A
        nuccstot = nuccstot/fluxv/1000.0*abs(w2v-mp2)
        signonuc = sigtot

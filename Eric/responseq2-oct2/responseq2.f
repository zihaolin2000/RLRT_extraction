...
c        write(6,*) RLTOT,RLIE+RLQE
      ...
      !   if(RTNS.LE.1.0E-40) then
      !      RTNS = 0.0
      !   endif
      !   if(RLNS.LE.1.0E-40) then
      !      RLNS = 0.0
      !   endif



        if(RTNS.GT.1.0E+10) then
           RTNS = 0.0
        endif
        if(RLNS.GT.1.0E+10) then
           RLNS = 0.0
        endif
   ...
   !   &       write(6,2000) qv,q2,ex,nu,RTTOT,RLTOT,
   !   &                      RTNS          
        !   q3, q2, excitation energy, nu, RT_total, RL_total, RT_quasielastic, RL_quasielastic, RT_inelastic, RL_inelastic, RT_total_elastic, 
   !   RL_total_elastic, RT_nuclear_states, RL_nuclear_states
...
!  2000  format(4f9.5,10E11.3)
      ! 4f9.5 means:   four real numbers, a field with width of 9 characters, among which 5 decimal places
      ! 10E11.3 means: ten real numbers, a field with width of 11 characters, among which 3 decimal places in exponential
 2000  format(4f9.5,10ES15.7)
